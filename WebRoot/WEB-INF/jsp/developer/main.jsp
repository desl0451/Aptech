...
<html lang="en">
  ...
  <body class="nav-md">
      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span>个人信息</span></a>
            </div>
            ...
            <div class="profile">
              <div class="profile_pic">
                <img src="${pageContext.request.contextPath }/statics/uploadfiles/studentpic/${stu.pic}" alt="..." class="img-circle profile_img">
              </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-table"></i> 班级学员 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <div class="x_content">
                    <div class="col-md-3 col-sm-3 col-xs-12 profile_left">
                      <div class="profile_img">
                        <div id="crop-avatar">
                          <!-- Current avatar -->
                          <img class="img-responsive avatar-view" width="220" height="320" src="${pageContext.request.contextPath }/statics/uploadfiles/studentpic/${stu.pic}" alt="${stu.username}" title="${stu.username }">
                        </div>
                      </div>
                      <h3>${stu.username}</h3>
                      ...
                      <ul class="list-unstyled user_data">
                        <li>
                      	    <i class="fa ffa fa-mobile"></i> 电话:${stu.phone}
                        </li>
                      
                        <li>
                        	<i class="fa fa-map-marker user-profile-icon"></i> ${stu.address}
                        </li>
                        <li>
	                        <i class="fa fa-briefcase user-profile-icon"></i> <fmt:formatDate value="${stu.borndate}" pattern="yyyy-MM-dd" />
                        </li>
                        <li>
	                        <i class="fa fa-qq"></i> ${stu.qq }
                        </li>
                        <li>
	                        <i class="fa fa-briefcase user-profile-icon"></i> <fmt:formatDate value="${stu.admissiondate }" pattern="yyyy-MM-dd" />
                        </li>
                        <li>
	                        <i class="fa fa-envelope"></i> ${stu.email }
                        </li>
                        <li class="m-top-xs">
                      ...
                      <a class="btn btn-success"><i class="fa fa-edit m-right-xs"></i>修改资料</a>
                      <br />
        ...
        <footer>
          <div class="pull-right">
         		   青鸟精神，永不妥协的教育品质紧跟IT行业变化，<br/>打造适应时代需求的职业教育产品支持你成为一个受人尊重的专业人才
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
    ...
    <!-- morris.js -->
    <script src="${pageContext.request.contextPath }/statics/js/raphael.min.js"></script>
    <script src="${pageContext.request.contextPath }/statics/js/morris.min.js"></script>
    <!-- bootstrap-progressbar -->
